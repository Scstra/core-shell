 ...
 * próprio, e os domínios ainda estão sendo definidos — por isso a URL vem de
 * fora, por configuração, e o componente sabe lidar com sistema **sem URL**:
 * ele aparece desabilitado, com o motivo, em vez de virar link morto.
 *
...
/**
 * Monta o mapa de URLs a partir de variáveis de ambiente.
 *
